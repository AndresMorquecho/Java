...
public class Item {
	...
	System.out.println( "Nombre del Producto: " +  nombre +  "Productos Actuales: " + productosActuales + " Productos Devueltos: " + productosDevueltos + " Productos Vendidos: " + productosVendidos);
