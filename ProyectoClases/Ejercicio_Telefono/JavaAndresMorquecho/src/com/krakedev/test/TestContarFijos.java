...
public class TestContarFijos {
	 public static void main(String[] args) {
	        ...
	        contacto1.agregarTelefonos(new Telefono("9876549", "Convencional"));
	        ...
	        contacto2.agregarTelefonos(new Telefono("9876543218", "Movil"));
	        ...
	        contacto3.agregarTelefonos(new Telefono("9876349", "Convencional"));
